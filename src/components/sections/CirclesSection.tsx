      ...
      <div className="circles-container">
        ...
        >
          <p className="circles-intro">
            To structure access, engagement, and leadership within the
            community, we use a model called
            <strong> Elmentor Circles</strong>. These circles define different
            levels of participation and responsibility, arranged in clear
            layers:
          </p>
        </div>
        ...
        <div className="circles-content">
          ...
          >
            <p>
              This model helps us structure engagement, learning, and
              decision-making in a clear and scalable way.
            </p>
          </div>
