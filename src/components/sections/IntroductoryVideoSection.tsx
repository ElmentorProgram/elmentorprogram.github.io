  ...
  return (
    ...
    >
      <div className="intro-video-container">
        <h2 id="video-title" className="intro-video-title">
          Discover DevOps Visions: Watch Our Introduction
        </h2>
        <p className="intro-video-subtitle">
          Get a quick overview of the DevOps Visions Program and learn how it
        ...
        <p id="video-description" className="video-description">
          This introductory video provides an overview of the DevOps Visions
          Program, explaining how our mentorship approach can accelerate your
        ...
        <div className="video-cta-section">
          ...
          <p className="video-cta-text">
            After watching our introduction, take the next step and join our
