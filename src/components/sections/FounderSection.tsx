  ...
  return (
    ...
    >
      <div className="founder-container">
        <h2 id="founder-title" className="founder-section-title">
          About the Founder
        </h2>
        <div className="founder-content-wrapper">
          ...
          <div className="founder-details-container">
            ...
            <p className="founder-title" role="text">
              {founderTitle}
            </p>
            <p className="founder-bio" role="text">
              {bio}
            </p>
            ...
            <div className="founder-cta-section">
              <h4 className="founder-cta-title">
                Ready to Learn from Mohamed?
              </h4>
              <p className="founder-cta-text">
                Connect with Mohamed and start your journey with personalized
