  ...
  return (
    ...
    >
      <div className="community-presence-container">
        <h2 id="community-title" className="community-presence-title">
          Stay Connected & Engage
        </h2>
        <p className="community-presence-subtitle">
          Join our vibrant community across various platforms and be part of the
          conversation.
        </p>{" "}
        <div className="channels-category">
          ...
          <div
            ...
            role="list"
            aria-label="DevOps Visions Public Community social media channels"
          >
