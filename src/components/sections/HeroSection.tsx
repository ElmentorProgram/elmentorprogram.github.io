    ...
    <section className="elmentor-hero" id="hero" ref={heroRef}>
      ...
      <div className="elmentor-hero-content">
        <h1 className="elmentor-hero-title">
          Join Elmentor Program: A Private Community for Continuous Learning and
          Professional Growth.
          <br />
          <span className="elmentor-hero-slogan">
            Empower through mentorship.
          </span>
        </h1>

        <p className="elmentor-hero-subhead">
          Connect, collaborate, and elevate your skills with a diverse network
          of tech enthusiasts and experts.
          <br />
          As we believe,{" "}
          <span className="elmentor-hero-quote">
